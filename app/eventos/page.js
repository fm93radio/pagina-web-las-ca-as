...
const WHATSAPP_NUMBER = '59800000000'; // Placeholder - actual request by user
...
export default function EventQuote() {
    ...
    const handleSendWhatsApp = async () => {
        ...
        const reservationData = {
            ...
            fecha_evento: date,
            duracion_salon: hours,
            extras: extras,
            precio_estimado: priceDetails.total,
            estado: 'pendiente'
        };
        ...
        try {
            ...
            if (error) {
                ...
                // We proceed to WhatsApp anyway so the user doesn't lose the lead
            }
        } catch (err) {
